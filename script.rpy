...
define so = Character("Sophie", color='#d6e760')
define a = Character("Amy", color='#d366da')
define ass = Character("Some Asshole")
define dn = Character("Dani", color='#e47676')
define ds = Character("Daisy", color='#0e0ac2')
define j = Character("Jenna", color = '#5c0d0d')
define m = Character("Maria", color='#be2121')
define ma = Character("Mayan", color='#754268')
define h = Character("Hikari", color='#a586bf')
define w = Character("Walter", color='#634216')
define tv = Character("TV")
define his = Character("Historic Channel")
define who = Character("???")
define ba = Character("Bartender")
define com = Character("Commentator")
define man = Character("Man")
define woman = Character("Woman")
define woman1 = Character("Woman 1")
define woman2 = Character("Woman 2")
...
label start:
    scene black
    $ pass_time(60)
    $ mainname = renpy.input("What's your name?", "Simon")
