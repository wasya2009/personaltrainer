...
screen fattie_treadmill_button:
    ...
    imagebutton:
        ...
        yalign 0.42
        focus_mask True
        auto "gui/icons/point_of_interest_%s.png" hovered tt.Action(_("Look"))
...
screen saggy_tits_latina_sauna_button:
    ...
    imagebutton:
        ...
        yalign 0.23
        focus_mask True
        auto "gui/icons/point_of_interest_%s.png" hovered tt.Action(_("Talk to her"))
...
screen bored_gf_button:
    ...
    imagebutton:
        ...
        yalign 0.5
        focus_mask True
        auto "gui/icons/point_of_interest_%s.png" hovered tt.Action(_("Eavesdrop"))
...
screen mayan_ruclark1_button:
    ...
    imagebutton:
        ...
        yalign 0.38
        focus_mask True
        auto "gui/icons/point_of_interest_%s.png" hovered tt.Action(_("Approach"))
