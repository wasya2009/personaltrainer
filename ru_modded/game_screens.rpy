...
screen ui_text:
    ...
    text _('+ 1H') size 16 color "#ffffff" font "Roboto-Bold.ttf" xpos 115 ypos 9
    text _('+ 6H') size 16 color "#ffffff" font "Roboto-Bold.ttf" xpos 180 ypos 9
...
screen ui_icons:
    ...
    imagebutton: #+ 1 hour
        ...
        ypos -30
        focus_mask True
        auto "gui/icons/hour_icon_%s.png" hovered tt.Action(_("+ 1 hour")) action [Function(pass_time, 60), Call(last_label)]

    imagebutton: #+ 6 hours
        xpos 140
        ypos -30
        focus_mask True
        auto "gui/icons/hour_icon_%s.png" hovered tt.Action(_("+ 6 hours")) action [Function(pass_time, 360), Call(last_label)]

    imagebutton: # Sleep
        xpos 205
        ypos -30
        focus_mask True
        auto "gui/icons/hour_icon_%s.png" hovered tt.Action(_("Go to Sleep")) action [Jump('sleep')]

    imagebutton: #Patreon
        xpos 1830
        ypos 1000
        focus_mask True
        auto "gui/icons/patreon_icon_%s.png" hovered tt.Action(_("Follow Domiek"))
    ...
    imagebutton: #Map
        ...
        ypos 5
        focus_mask True
        auto "gui/icons/map_%s.png" hovered tt.Action(_("Map"))
    ...
    imagebutton: #Phone
        ...
        ypos 5
        focus_mask True
        auto "gui/icons/phone_%s.png" hovered tt.Action(_("Memories Gallery"))
    ...
    imagebutton: #Hints
        ...
        ypos 5
        focus_mask True
        auto "gui/icons/relations_%s.png" hovered tt.Action(_("Hints"))
...
screen map:
    ...
    imagebutton: # Sophie
        ...
        ypos 351
        focus_mask True
        auto ("gui/map_icons/home_%s.png") hovered tt.Action(_("Sophie's Apartment"))
    ...
    if amy_recon:
        imagebutton: # Amy
            ...
            ypos 750
            focus_mask True
            auto ("gui/map_icons/amy_%s.png") hovered tt.Action(_("Amy's Place"))
            clicked [Show("ui_icons"), Show("ui_text"), Jump("loc_amy")]
    imagebutton: # Gym
        xpos 1219
        ypos 534
        focus_mask True
        auto ("gui/map_icons/gym_%s.png") hovered tt.Action(_("Gym"))
        clicked [Show("ui_icons"), Show("ui_text"), Jump("loc_gym")]
    imagebutton: # Coffee
        xpos 1105
        ypos 821
        focus_mask True
        auto ("gui/map_icons/coffee_%s.png") hovered tt.Action(_("Coffee Shop"))
        clicked [Show("ui_icons"), Show("ui_text"), Jump("loc_coffee")]
    imagebutton: # Arcade
        xpos 1137
        ypos 307
        focus_mask True
        auto ("gui/map_icons/arcade_%s.png") hovered tt.Action(_("Arcade"))
        clicked [Show("ui_icons"), Show("ui_text"), Jump("loc_arcade")]
    imagebutton: # Strip Club
        xpos 835
        ypos 643
        focus_mask True
        auto ("gui/map_icons/stripclub_%s.png") hovered tt.Action(_("Strip Club"))
...
screen store_items:
    ...
    imagebutton auto "locations/store/gym_clothes_%s.jpg" xpos 365 ypos 136 focus_mask True hovered tt.Action(_("Gym Clothes")) action Return ("gym_clothes")
...
screen loc_sophie_nav:
    ...
    imagebutton: #Living room
        ...
        ypos 980
        focus_mask True
        auto "locations/sophie_apartment/livingroom_%s.png" hovered tt.Action(_("Living Room"))
    ...
    imagebutton: #Kitchen
        ...
        ypos 980
        focus_mask True
        auto "locations/sophie_apartment/kitchen_%s.png" hovered tt.Action(_("Kitchen"))
    ...
    imagebutton: #Bedroom
        ...
        ypos 980
        focus_mask True
        auto "locations/sophie_apartment/bedroom_%s.png" hovered tt.Action(_("Bedroom"))
    ...
    imagebutton: #Bathroom
        ...
        ypos 980
        focus_mask True
        auto "locations/sophie_apartment/bathroom_%s.png" hovered tt.Action(_("Bathroom"))
...
screen loc_gym_nav:
    ...
    imagemap:
        ...
        hotspot (14, 1004, 103, 59) clicked Jump("loc_gym") hovered tt.Action(_("Lobby"))
        hotspot (120, 1004, 103, 59) clicked Jump("loc_gym_gym") hovered tt.Action(_("Main Floor"))
        hotspot (226, 1004, 103, 59) clicked Jump("loc_gym_yoga") hovered tt.Action(_("Yoga"))
        hotspot (331, 1004, 103, 59) clicked Jump("loc_gym_sauna") hovered tt.Action(_("Sauna"))
        hotspot (434, 1004, 103, 59) clicked Jump("loc_gym_pool") hovered tt.Action(_("Pool"))
        hotspot (539, 1004, 103, 59) clicked Jump("loc_gym_locker") hovered tt.Action(_("Locker Room"))
        hotspot (644, 1004, 103, 59) clicked Jump("loc_gym_office") hovered tt.Action(_("Office"))
