...
screen sophie_breakfast_button:
    ...
    imagebutton:
        ...
        yalign 0.25
        focus_mask True
        auto "gui/icons/point_of_interest_%s.png" hovered tt.Action(_("Talk to Sophie"))
...
screen sophie_yoga_button:
    ...
    imagebutton:
        ...
        yalign 0.18
        focus_mask True
        auto "gui/icons/point_of_interest_%s.png" hovered tt.Action(_("Watch"))
...
screen amy_gym_button:
    ...
    imagebutton:
        ...
        yalign 0.3
        focus_mask True
        auto "hotbutton/amy_gymgym_%s.png" hovered tt.Action(_("Amy")) #action NullAction()
...
screen amy_locker_button:
    ...
    imagebutton:
        ...
        yalign 0.3
        focus_mask True
        auto "hotbutton/amy_locker_%s.png" hovered tt.Action(_("Amy")) #action NullAction()
...
screen dani_office_button:
    ...
    imagebutton:
        ...
        ypos 0
        focus_mask True
        auto "hotbutton/dani_office_%s.png" hovered tt.Action(_("Dani"))
...
screen daisy_reception_button:
    ...
    imagebutton:
        ...
        yalign 0.3
        focus_mask True
        auto "hotbutton/daisy_reception_%s.png" hovered tt.Action(_("Daisy")) #action NullAction()
...
screen hikari_pool_button:
    ...
    imagebutton:
        ...
        ypos 0
        focus_mask True
        auto "hotbutton/gym_pool_hikari_%s.png" hovered tt.Action(_("Hikari"))
...
screen hikari_nude_pool_sit_button:
    ...
    imagebutton:
        ...
        yalign 0.39
        focus_mask True
        auto "gui/icons/point_of_interest_%s.png" hovered tt.Action(_("Talk to Hikari"))
...
screen hikari_swim_button:
    ...
    imagebutton:
        ...
        ypos 0
        focus_mask True
        auto "hotbutton/gym_swim_hikari_%s.png" hovered tt.Action(_("Hikari"))
...
screen hikari_swim_nude_button:
            ...
            imagebutton:
                ...
                ypos 0
                focus_mask True
                auto "hotbutton/hikari_swim_nude_%s.png" hovered tt.Action(_("Hikari"))
                clicked [Hide("ui_icons"), Hide("ui_text"), Jump("hikari_pool_swim")]
screen hikari_locker_button:
    ...
    imagebutton:
        ...
        ypos 0
        focus_mask True
        auto "hotbutton/hikari_locker_%s.png" hovered tt.Action(_("Hikari"))
...
screen hikari_nudelocker_button:
    ...
    imagebutton:
        ...
        ypos 0
        focus_mask True
        auto "hotbutton/hikari_locker_nude_%s.png" hovered tt.Action(_("Hikari"))
        clicked [Hide("ui_icons"), Hide("ui_text"), Jump("hikari_locker")]
...
screen jenna_bench_button:
    ...
    imagebutton:
        ...
        ypos 0
        focus_mask True
        auto "hotbutton/jenna_bench_%s.png" hovered tt.Action(_("Jenna"))
...
screen jenna_shower_button:
    ...
    imagebutton:
        ...
        yalign 0.08
        focus_mask True
        auto "gui/icons/point_of_interest_%s.png" hovered tt.Action(_("Look at Jenna"))
...
screen maria_shower_button:
    ...
    imagebutton:
        ...
        ypos 0
        focus_mask True
        auto "hotbutton/maria_locker_shower_%s.png" hovered tt.Action(_("Maria")) #action NullAction()
...
screen maria_treadmill_button:
    ...
    imagebutton:
        ...
        ypos 0
        focus_mask True
        auto "hotbutton/maria_treadmill_%s.png" hovered tt.Action(_("Maria"))
...
screen maria_sauna_button:
    ...
    imagebutton:
        ...
        ypos 0
        focus_mask True
        auto "hotbutton/maria_sauna_%s.png" hovered tt.Action(_("Maria")) #action NullAction()
...
screen bartender_button:
    ...
    imagebutton:
        ...
        yalign 0.25
        focus_mask True
        auto "gui/icons/point_of_interest_%s.png" hovered tt.Action(_("Talk")) #action NullAction()
